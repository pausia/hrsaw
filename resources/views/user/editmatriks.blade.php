<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            ...
            <form action="{{ route('matriks.edit', ['id' => $matriks->id]) }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="id_criteria" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kriteria</label>
                    ...
                    <div class="sm:col-span-2">
                        <label for="value" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nilai</label>
                        <input type="number" name="value" id="value" value="{{ $matriks->weight }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500" required="">
                    </div>
                </div>
