    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          ...
          <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Hi! <span class="text-indigo-700 font-bold">{{ Auth::user()->name }}</span> Silahkan Tambah Criteria</h1>
            <p class="mb-6 leading-relaxed">Lakukan penambahan Data Criteria sesuai keinginan anda dan raih kandidat terbaik anda.</p>
