    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          ...
          <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Hi! <span class="text-indigo-700 font-bold">{{ Auth::user()->name }}</span> Silahkan Tambah Alternatif</h1>
            <p class="mb-6 leading-relaxed">Lakukan penambahan Data Alternatif sesuai keinginan anda dan raih kandidat terbaik anda.</p>
  ...
  <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Alternatif</h3>
